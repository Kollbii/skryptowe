...
class Test_TestSkrypt(unittest.TestCase):
    ...
    def test_only_word(self):
        for answer in skrypt.extract("DlugiTekstTylko znakami i   spacjami"):
    ...
    def test_combine_all(self):
        for answer in skrypt.extract("Full dis-99closure, Morty - it's not. Temporary superintell11igence."):
